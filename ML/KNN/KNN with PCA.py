...
# 2) AUC-ROC
# PKM2
y_probs_PKM2 = best_model_PKM2.predict_proba(X_test_PKM2_pca)[:,1]  # Predict probabilities for the positive class
...
# ERK2
y_probs_ERK2 = best_model_ERK2.predict_proba(X_test_ERK2_pca)[:,1]  # Predict probabilities for the positive class
