...
# KNN for PKM2
parameters_PKM2 = {'n_neighbors': np.arange(1, 20)}
...
# KNN for ERK2
parameters_ERK2 = {'n_neighbors': np.arange(1, 20)}
...
# Additional metrics
# Calculate F1-score, Precision, Recall, and AUC-ROC for PKM2 inhibition
...
# Calculate F1-score, Precision, Recall, and AUC-ROC for ERK2 inhibition
