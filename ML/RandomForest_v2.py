...
parameters_PKM2 = {
    'n_estimators': [110,120,130,140],  # Number of trees in the forest
    'max_depth': [25,30,35,40,45],  # Maximum depth of the tree
    'min_samples_split': [2, 3],  # Minimum number of samples required to split an internal node
    'min_samples_leaf': [2, 4],  # Minimum number of samples required to be at a leaf node
    'bootstrap': [True],  # Whether bootstrap samples are used when building trees
    'criterion': ['gini','entropy','log_loss'],
    'max_features':[20,25,30,52]
}
...
parameters_ERK2 = {
    'n_estimators': [110,120,130],  # Number of trees in the forest
    'max_depth': [25,30,35,40],  # Maximum depth of the tree
    'min_samples_split': [2, 3],  # Minimum number of samples required to split an internal node
    'min_samples_leaf': [2, 4],  # Minimum number of samples required to be at a leaf node
    'bootstrap': [True],  # Whether bootstrap samples are used when building trees
    'criterion': ['gini','entropy','log_loss'],
    'max_features':[25,30,35,43]
}
...
bacc_PKM2 = metrics.balanced_accuracy_score(Y_test_PKM2, Y_pred_test_PKM2)
bacc_ERK2 = metrics.balanced_accuracy_score(Y_test_ERK2, Y_pred_test_ERK2)

print(f"balanced accuracy PKM2: {bacc_PKM2:.2f}")
print(f"balanced accuracy ERK2: {bacc_ERK2:.2f}")
