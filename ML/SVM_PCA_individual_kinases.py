...
scoring_PKM2 = {'accuracy': 'accuracy', 'f1_micro': 'f1_micro', 'roc_auc': 'roc_auc'}

# Initialize the SVM classifier
classifier_PKM2 = SVC(probability=True)

# Initialize GridSearchCV for SVM
gs_PKM2 = GridSearchCV(classifier_PKM2, parameters_PKM2, cv=2, scoring=scoring_PKM2, verbose=90, n_jobs=-1, refit='roc_auc')
...
# Define the scoring metrics 
scoring_ERK2 = {'accuracy': 'accuracy', 'f1_micro': 'f1_micro', 'roc_auc': 'roc_auc'}

# Initialize the SVM classifier
classifier_ERK2 = SVC(probability=True)

# Initialize GridSearchCV for SVM
gs_ERK2 = GridSearchCV(classifier_ERK2, parameters_ERK2, cv=2, scoring=scoring_ERK2, verbose=90, n_jobs=-1, refit='roc_auc')
