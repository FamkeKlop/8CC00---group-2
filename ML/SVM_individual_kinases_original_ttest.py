...
# From this dataset, only the features are used that were also considered to be 
# significant according to the previously performed t-test.
# The resulting dataset is then used to predict the inhibition of PKM2 and ERK2 separately.
